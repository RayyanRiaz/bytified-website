...
<template>
  <div>
    <div class="flex flex-col px-10 md:px-20 pt-64 gap-2">
      <h1 class="pb-10 underline">Terms And Conditions</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            to Bytified Private Limited, House # 486, Street # 3, 44000 Islamabad.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a href="https://www.termsfeed.com/terms-conditions-generator/" target="_blank" rel="noopener"
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Bytified, accessible from
            <a href="https://www.termsfeed.com/live/bytified.com" target="_blank" rel="external nofollow noopener"
              >bytified.com</a
            >
          </p>
        </li>
      ...
      <ul>
        <li>By email: contact@bytified.com</li>
      </ul>
    </div>
  </div>
</template>
