<template>
  <div>
    <div class="flex flex-col px-10 md:px-20 pt-64 gap-2">
      <HeadingH1 class="pb-10 underline">Privacy Policy</HeadingH1>
      <p>
        We are very delighted that you have shown interest in our enterprise. Data protection is of a particularly high
        priority for the management of the Bytified Private Limited. The use of the Internet pages of the Bytified
        Private Limited is possible without any indication of personal data; however, if a data subject wants to use
      ...
      <p>
        ...
        country-specific data protection regulations applicable to the Bytified Private Limited. By means of this data
        protection declaration, our enterprise would like to inform the general public of the nature, scope, and purpose
      ...
      <p>
        As the controller, the Bytified Private Limited has implemented numerous technical and organizational measures
        to ensure the most complete protection of personal data processed through this website. However, Internet-based
      ...
      <h4>1. Definitions</h4>
      <p>
        The data protection declaration of the Bytified Private Limited is based on the terms used by the European
        legislator for the adoption of the General Data Protection Regulation (GDPR). Our data protection declaration
        should be legible and understandable for the general public, as well as our customers and business partners. To
      ...
      <div>
        <p>Bytified Private Limited</p>
        <p>14B, Housing Colony</p>
        <p>Jaranwala</p>
        <p>Pakistan</p>
        <p>Phone: 03317749707</p>
        <p>Email: contact@bytified.com</p>
        <p>Website: bytified.com</p>
      </div>
      <h4>3. Cookies</h4>
      <p>
        The Internet pages of the Bytified Private Limited use cookies. Cookies are text files that are stored in a
      ...
      <p>
        Through the use of cookies, the Bytified Private Limited can provide the users of this website with more
      ...
      <p>
        ...
        on the user&#8217;s computer system. Another example is the cookie of a shopping cart in an online shop. The
      ...
      <p>
        The website of the Bytified Private Limited collects a series of general data and information when a data
      ...
      <p>
        When using these general data and information, the Bytified Private Limited does not draw any conclusions about
        the data subject. Rather, this information is needed to (1) deliver the content of our website correctly, (2)
        ...
        information necessary for criminal prosecution in case of a cyber-attack. Therefore, the Bytified Private
      ...
      <p>
        The website of the Bytified Private Limited contains information that enables a quick electronic contact to our
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            ...
            data stored by the Bytified Private Limited, he or she may, at any time, contact any employee of the
            controller. An employee of Bytified Private Limited shall promptly ensure that the erasure request is
          ...
          <p>
            ...
            of, those personal data, as far as processing is not required. An employees of the Bytified Private Limited
        ...
        <li>
          ...
          <p>
            ...
            processing of personal data stored by the Bytified Private Limited, he or she may at any time contact any
            employee of the controller. The employee of the Bytified Private Limited will arrange the restriction of the
            processing.
          </p>
        </li>
        <li>
        ...
        <li>
          ...
          <p>
            The Bytified Private Limited shall no longer process the personal data in the event of the objection, unless
            we can demonstrate compelling legitimate grounds for the processing which override the interests, rights and
            freedoms of the data subject, or for the establishment, exercise or defence of legal claims.
          </p>
          <p>
            If the Bytified Private Limited processes personal data for direct marketing purposes, the data subject
            ...
            subject objects to the Bytified Private Limited to the processing for direct marketing purposes, the
            Bytified Private Limited will no longer process the personal data for these purposes.
          </p>
          <p>
            In addition, the data subject has the right, on grounds relating to his or her particular situation, to
            object to processing of personal data concerning him or her by the Bytified Private Limited for scientific
            or historical research purposes, or for statistical purposes pursuant to Article 89(1) of the GDPR, unless
            the processing is necessary for the performance of a task carried out for reasons of public interest.
          </p>
          <p>
            In order to exercise the right to object, the data subject may contact any employee of the Bytified Private
            Limited. In addition, the data subject is free in the context of the use of information society services,
        ...
        <li>
          ...
          <p>
            ...
            suitable measures to safeguard the data subject&#8217;s rights and freedoms and legitimate interests, or (3)
          ...
          <p>
            ...
            subject and a data controller, or (2) it is based on the data subject&#8217;s explicit consent, the Bytified
            Private Limited shall implement suitable measures to safeguard the data subject&#8217;s rights and freedoms
          ...
          <p>
            ...
            may, at any time, contact any employee of the Bytified Private Limited.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            contact any employee of the Bytified Private Limited.
          </p>
        </li>
      </ul>
      <h4>8. Data protection for applications and the application procedures</h4>
      <p>
        The data controller shall collect and process the personal data of applicants for the purpose of the processing
      ...
      <h4>
        12. Provision of personal data as statutory or contractual requirement; Requirement necessary to enter into a
      ...
      <p>
        ...
        data subject must contact any employee. The employee clarifies to the data subject whether the provision of the
        personal data is required by law or contract or is necessary for the conclusion of the contract, whether there
